...
use llvm_sys::{
    core::{
        ...
        LLVMGlobalCopyAllMetadata, LLVMIsAFunction, LLVMIsAGlobalAlias, LLVMIsAGlobalObject,
        LLVMIsAGlobalVariable, LLVMIsAInstruction, LLVMIsAMDNode, LLVMIsAUser,
...
impl<'ctx> Function<'ctx> {
    ...
    //     self.value.as_ptr().basic_blocks_iter()
    // }
