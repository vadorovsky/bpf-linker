...
use llvm_sys::{
    core::{
        LLVMConstIntGetZExtValue, LLVMCountParams, LLVMDisposeValueMetadataEntries,
        LLVMGetNextInstruction, LLVMGetNumOperands, LLVMGetOperand, LLVMGetParam,
        LLVMGlobalCopyAllMetadata, LLVMHasMetadata, LLVMIsAConstantInt,
        LLVMIsADbgVariableIntrinsic, LLVMIsAFunction, LLVMIsAGetElementPtrInst,
